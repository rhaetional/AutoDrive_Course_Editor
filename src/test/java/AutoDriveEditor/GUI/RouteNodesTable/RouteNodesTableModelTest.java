...
class RouteNodesTableModelTest {
    ...
    void setUp() {
        ...
        testNode.createMapMarker("Test Marker", "Test Group", testId, Arrays.asList(20, 30, 33));
    ...
    void setValueAt() {
        ...
        newNode.createMapMarker("Different Marker", "Different Group", 999,Arrays.asList(1, 2, 3));
